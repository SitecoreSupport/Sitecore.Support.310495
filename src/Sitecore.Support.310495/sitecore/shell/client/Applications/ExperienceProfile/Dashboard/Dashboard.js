define(["sitecore", "/-/speak/v1/experienceprofile/DataProviderHelper.js", "/-/speak/v1/experienceprofile/CintelUtl.js"], function (sc, providerHelper, cintelUtil)
{
  var app = sc.Definitions.App.extend({
    ...
    initialized: function () {
      ...
      providerHelper.setDefaultSorting(this.VisitorsDataProvider, "Value", true);
    ...
    findContact: function () {
      var match = this.SearchTextBox.get('text') || "*";
      if (match == "*") {
        window.location.assign('Dashboard');
        return;
      }
      window.location.assign('search?text=' + encodeURIComponent(match));
    },
